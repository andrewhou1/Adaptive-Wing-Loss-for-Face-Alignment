...
all_imgs = sorted(os.listdir('/scratch1/tranluan/data/300W_LP_crop/image/HELEN_Flip/'))
#test_imgs = all_imgs[32324:]
train_imgs = all_imgs[:32324]
landmark_file = scipy.io.loadmat('../../Landmarks_by_dataset/HELEN_Flip_landmarks.mat')['landmarks']
...
for i in range(len(train_imgs)):
    img = cv2.imread('/scratch1/tranluan/data/300W_LP_crop/image/HELEN_Flip/'+train_imgs[i])
    cv2.imwrite('../training_data/HELEN_Flip/'+train_imgs[i], img)
...
scipy.io.savemat('../training_data/HELEN_Flip_training_landmarks.mat', output_mat)
