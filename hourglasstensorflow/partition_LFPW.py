...
all_imgs = sorted(os.listdir('/scratch1/tranluan/data/300W_LP_crop/image/LFPW/'))
test_imgs = all_imgs[:3666]
train_imgs = all_imgs[3666:]
landmark_file = scipy.io.loadmat('../../Landmarks_by_dataset/LFPW_landmarks.mat')['landmarks']
...
for i in range(len(train_imgs)):
    img = cv2.imread('/scratch1/tranluan/data/300W_LP_crop/image/LFPW/'+train_imgs[i])
    cv2.imwrite('../training_data/LFPW/'+train_imgs[i], img)
...
scipy.io.savemat('../training_data/LFPW_training_landmarks.mat', output_mat)
